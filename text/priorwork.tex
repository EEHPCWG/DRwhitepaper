...
response to a request from an electrical service provider \cite{INSERT PAPER} (Ghatikar et al., 2012a).
...
be accessible.
 ...
 \cite{INSERT PAPER} 
 (Ghatikar et al., 2012b) looks at two applied cases of distributed data centers.
